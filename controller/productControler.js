...
const viewProducts = async (req, res) => {
    try {
        ...
        if (req.query.ajax == "true") {
            ...
            res.render("backend/page-products-grid", { products, count, page })
        }
    } catch (error) {
        console.log(error.message)
    }
...
const deleteProduct = async (req, res) => {
    try {
        ...
        if (product) res.json({ response: "removed" })
        else
            res.send(
                '<script>alert("Something went wrong");windoow.location.href="/backEnd/page-products-grid.ejs"</script>'
            )
    } catch (error) {
        console.log(error.message)
    }
...
const editingProduct = async (req, res) => {
    try {
        ...
        if (productUpdate) res.redirect("/admin/viewProducts")
        else res.send('<script>alert("Something went wrong")</script>')
    } catch (error) {
        console.log(error.message)
    }
